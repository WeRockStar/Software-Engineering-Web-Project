        ...
        <script type="text/javascript">
            $(function () {
                $('#form-profile').submit(function () {
                    var data = $('#username , #password , #fname , #lname , #bday , #address , #tel, #email , #id').serializeArray(); //send json
                    $.ajax({
                            ...
                            <div class="caption">
                                ...
                                <form class="form" id="form-profile">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="username" class="form-control" name="username" value="<?php echo $user; ?>"  placeholder="username">                                                                                    
                                    </div>                                    
                                    <div class="form-group">                                        
                                        <label class="" >password : </label>                                            
                                        <input type="password" id="password" class="form-control" name="password" value="<?php echo $pass; ?>"  placeholder="password">                                            
                                    </div>
                                    <div class="form-group">                                                                               
