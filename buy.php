                                ...
                                <table class='table table-hover table-responsive'>
                                    ...
                                    <tbody class='text-center'>
                                        ...
                                        if (count($_SESSION['cart_items']) > 0) {
                                            ...
                                            foreach ($_SESSION['cart_items'] as $id => $value) {
                                                ...
                                                if ($type1 == 'seller') {
                                                    ...
                                                    echo "<td class='row-tournament'> <form class='update-quantity-form'><div class='input-group'>
															<input type='number' name='quantity' value='{$quantity}' min='1' class='form-control' readonly='readonly' required=''>
															<input type='hidden' name='id' value='{$ids}'class='form-control' required=''>
															</div></form></td>";
                                                    ...
                                                    echo "<td class='row-tournament'> <form class='update-quantity-form' action='UpdateCart.php'><div class='input-group'>
															<input type='number' name='quantity' value='{$quantity}' min='1' class='form-control' required=''>
															<input type='hidden' name='id' value='{$ids}'class='form-control' required=''>
															<span class='input-group-btn'><button type='submit' class='btn btn-default'>Update</button></span>
															</div></form></td>";
                                        ...
                                        <tr>
                                            ...
                                            <td class='row-tournament'><a class='btn btn-default' href='checkout.php'>Checkout</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
